...
class CustomVideoProgressIndicator extends StatefulWidget {
  ...
  /// to `top: 5.0`.
   CustomVideoProgressIndicator(
      ...
      }) : colors = colors ?? const VideoProgressColors();
...
class _CustomVideoProgressIndicatorState extends State<CustomVideoProgressIndicator> {
  ...
  void calculateDurationDiffs() {
    ...
    final firstDifference = timestamps.first.inSeconds - Duration.zero.inSeconds;
...
class _VideoScrubberState extends State<_VideoScrubber> {
  ...
  Widget build(BuildContext context) {
    ...
    void seekToRelativePosition(Offset globalPosition) {
      final renderedObject = context.findRenderObject() as RenderBox;
      final Offset tapPos = renderedObject.globalToLocal(globalPosition);
      final double relative = tapPos.dx / renderedObject.size.width;
